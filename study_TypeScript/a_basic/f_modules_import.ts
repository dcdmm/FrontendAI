...
import {add, PI, subtract, User, Calculator, VERSION, AUTHOR, multiply} from './f_modules_export';
// 重命名导入
import {divide as divide_as} from './f_modules_export';

let result_d = divide_as(10, 2);
console.log(`10 / 2 = ${result_d}`);

// 所有导出的内容放在eme对象里(避免命名冲突)
import * as eme from './f_modules_export';
...
import hello_x from './f_modules_export';
